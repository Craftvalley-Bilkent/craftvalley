...
def admin_dashboard(request):
    ...
    """)
    return render(request, 'adminpanel/dashboard.html', {'reported_businesses': reported_businesses})
...
def popular_products(request):
    ...
    """)
    return render(request, 'adminpanel/popular_products.html', {'popular_products': popular_products})
...
def user_trends(request):
    ...
    """)
    return render(request, 'adminpanel/user_trends.html', {'user_trends': user_trends})
...
def platform_performance(request):
    platform_performance = raw_sql_query("""
        ...
        FROM User
    """)
    return render(request, 'adminpanel/platform_performance.html', {'platform_performance': platform_performance})
